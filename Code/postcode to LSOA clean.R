...
# Load dataset
Postcode_to_LSOA <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/LSOA_data/Postcode to LSOA 1.csv")
...
write_csv(Postcode_to_LSOA_clean, "Coursework_sagarkadel35D_230499/Cleaned_Data/Postcode_to_LSOA_clean.csv")
