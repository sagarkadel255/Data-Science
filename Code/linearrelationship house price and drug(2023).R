...
drug_data <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/drug_rates_2023.csv")
house_data <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/cleaned_house_prices.csv")
