...
house_prices <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/cleaned_house_prices.csv")
broadband <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/cleanBroadband.csv")
