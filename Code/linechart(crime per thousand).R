...
# Load datasets
Population <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/population/Population.csv")
postcode_to_lsoa <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/Postcode_to_LSOA_clean.csv") %>%
  select(Postcode, LSOA_Code, District)
crime_data <- read_csv("Coursework_sagarkadel35D_230499/Cleaned_Data/cleaned_crime.csv")
