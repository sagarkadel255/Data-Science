...
performance <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/broadband/fixed_postcode_performance.csv")
coverage <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/broadband/fixed_postcode_coverage.csv")
...
write_csv(broadband_clean, "Coursework_sagarkadel35D_230499/Cleaned_Data/cleanBroadband.csv")
