...
south_yorkshire <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/crimerate/2025-05-south-yorkshire-street.csv")
west_yorkshire <- read_csv("Coursework_sagarkadel35D_230499/Obtained_Data/crimerate/2025-05-west-yorkshire-street.csv")
...
# Step 9: Save outputs
write_csv(cleaned_crime, "Coursework_sagarkadel35D_230499/Cleaned_Data/cleaned_crime.csv")
write_csv(crime_summary, "Coursework_sagarkadel35D_230499/Cleaned_Data/crime_summary.csv")
write_csv(unique_districts, "Coursework_sagarkadel35D_230499/Cleaned_Data/unique_districts.csv")
